...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    selectsucursal: function selectsucursal() {
      ...
      this.sucursalselect = JSON.parse(localStorage.getItem("sucursalselect"));
    },
    changesucursal: function changesucursal() {
      localStorage.setItem("sucursalselect", JSON.stringify(this.sucursalselect));
      location.reload();
    },
...
/* harmony import */ var _compontents_widgets_stat_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../compontents/widgets/stat.vue */ "./resources/js/compontents/widgets/stat.vue");
/* harmony import */ var _sales_analytics_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sales-analytics.vue */ "./resources/js/views/pages/dashboard/sales-analytics.vue");
/* harmony import */ var _selling_product_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./selling-product.vue */ "./resources/js/views/pages/dashboard/selling-product.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  components: {
    ...
    Stat: _compontents_widgets_stat_vue__WEBPACK_IMPORTED_MODULE_1__["default"],
    SalesAnalytics: _sales_analytics_vue__WEBPACK_IMPORTED_MODULE_2__["default"],
    SellingProduct: _selling_product_vue__WEBPACK_IMPORTED_MODULE_3__["default"]
  },
  data: function data() {
    return {
      title: "Dashboard",
...
var secretarias = false;
var previsiones = false;
var profesionales = false;
var bloqueohora = false;
var pacientes = false;
var reservas = false;
                ...
                _vm._l(_vm.menuItems, function (item) {
                  return [
                    item.isTitle && item.permiso
                      ...
                      : _vm._e(),
                    _vm._v(" "),
                    !item.isTitle && !item.isLayout && item.permiso
                      ? _c(
                          "li",
                          { key: item.id },
                          [
...
var render = function () {
  ...
  return _c("header", { attrs: { id: "page-topbar" } }, [
    _c("div", { staticClass: "navbar-header" }, [
      _c(
        "div",
        { staticClass: "d-flex", staticStyle: { width: "30% !important" } },
        [
          _c(
            "div",
            { staticClass: "navbar-brand-box" },
          ...
          _c(
            ...
            [
              _c("multiselect", {
                ...
                on: {
                  input: function ($event) {
                    return _vm.changesucursal()
                  },
                },
                model: {
                  value: _vm.sucursalselect,
                  callback: function ($$v) {
                    _vm.sucursalselect = $$v
                  },
                  expression: "sucursalselect",
                },
              }),
            ],
            1
